...
\huge
\noindent \textbf{Contents}\\[-0.5em]
\par
\large
\noindent \textbf{\uline{\hskip -6em \hskip 6em Introduction\hskip 12em}}\\
\small
■ OpenToonz Main File Formats \ \ \ \ \ \ \ \ \ \ \ \ p.3\\
■ OpenToonz Interface \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.3\\
□ Room Information \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.3\\
□ Panel Customization \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.3\\
□ File Browser Interface \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.4\\[0.5em]
\par
\large
\noindent \textbf{\uline{\hskip -6em \hskip 6em Scanning\hskip 14em}}\\
\small
□ GTS Scanning Tool \ ※ Please refer to the "GTS Manual"\\[1.5em]
\par
\large
\noindent \textbf{\uline{\hskip -6em \hskip 6em Trace (Cleanup)\hskip 10.5em}}\\
\small
□ tlv File Creation \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.4\\
□ Without Antialiasing, Creating a tlv File With No Changes To Size \ \ p.8\\[2em]
\par
\large
\noindent \textbf{\uline{\hskip -6em \hskip 6em Finishing (InknPaint)\hskip 7.5em}}\\
\small
□ Level File Loading \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.9 \ \ \ \ \ \ \ □ Canceling an Operation \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.15\\
□ Level File Saving \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.9 \ \ \ \ \ \ \ □ Displaying Sequential Frame Numbers \ \ \ \ p.16\\
□ Level File Creation \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.9 \ \ \ \ \ \ \ □ Duplication \& Deletion of the Frame \ \ \ \ p.16\\
□ Palette File Saving \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.9 \ \ \ \ \ \ \ □ Switching Image on the Display Menu \ \ \ \ p.16\\
□ Scene File Loading \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.10 \ \ \ \ \ \ □ Displaying Various Kinds of Window \ \ \ \ \ p.17\\
□ Scene File Saving \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.10 \ \ \ \ \ \ □ Palette Style Editing \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.17\\
□ Scene File Creation \& Closing a Scene File \ \ p.10 \ □ Studio Palette Information \ \ \ \ \ \ \ \ \ \ \ \ \ p.18\\
□ OpenToonz Exiting \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.10 \ \ \ \ \ \ □ Studio Palette Folder Creation \& Deletion,\\
□ Cell Synthesis \& Cutting of Cells \ \ \ \ \ \ p.11 \ \ \ \ \ \ \ \ \ to Create a New Palette. \ \ \ \ \ \ \ \ \ \ \ \ \ \, p.18\\
□ Extracting Color from the Picture \ \ \ \ \ \ p.13 \ \ \ \ \ \ □ Viewing the Image \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.20\\
□ Connecting Broken Lines Automatically \ \ p.13 \ \ \ \ \ \ □ Time Sheet Editing \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.21\\
□ Line Modification \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.13 \ \ \ \ \ \ □ Viewing the Color Swatch Used in Painting \ \ p.21\\
□ Filling an Area \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.13 \ \ \ \ \ \ □ Browsing the Files \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.22\\
□ Drawing with a Brush \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.13 \ \ \ \ \ \ □ tlv Frame Viewing \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.22\\
□ Entering Text Characters \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.14 \ \ \ \ \ \ □ Previewing Image Sequences in a Video \ \ p.23\\
□ Turning Off the Line-Painted Area \ \ \ \ \ \ p.14 \ \ \ \ \ \ □ Environment Settings \& Keyboard Shortcuts \ \ p.23\\
□ Image Copy/Paste Selected Range, \& Movement \ p.14 \ □ Various Display Menus \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.23\\
□ Vector Image Editing \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.15 \ \ \ \ \ \ □ Window Layout Customization \ \ \ \ \ \ \ \ \ \ \ \ p.23\\
□ Image Display Tools \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ p.15 \ \ \ \ \ \ □ tlv File Conversion to Other File Formats \ \ p.24\\[1em]
\par
\large
\noindent \textbf{\uline{\hskip -6em \hskip 6em Color Specification (PltEdit)\hskip 4em}}\\
\small
□ Sheet Creation to Perform Color Designation \ p.25\\
□ Displaying a Specific Frame \ \ \ \ \ \ \ \ \ \ \ \ p.25\\
□ Previewing in a Transparent Display \ \ \ \ p.26
...
\footnotesize
\hskip 34em Room shows the menus \& layout specific to each job\par
...
\normalsize
\noindent \hskip -0.5em 【Step 2】\\[-0.5em]
\par
\footnotesize
...
\noindent \hskip 17em Toonz Palettes… Specifies the \$TOONZSTUDIOPALETTES folder\par
...
\par
\noindent \hskip 20.75em 【Right-Click Menu】\par
...
\par
\noindent \hskip -0.5em 【How to Create a Sub-Xsheet】\\
