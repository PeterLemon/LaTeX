...
\usepackage{fontspec}
\setmainfont[Path=fonts/, Extension=.ttf]{epkyouka}
...
\setlength\cftsubsecindent{7.7em }
...
\hskip -0.5em “V9938 MSX-VIDEO Technical Data Book"\hskip -0.5em.\\
\par
...
\addcontentsline{toc}{section}{[1] \ GENERAL DESCRIPTION}
...
\addcontentsline{toc}{section}{[2] \ FEATURES}
...
\addcontentsline{toc}{section}{[3] \ INTERNAL STRUCTURE BLOCK DIAGRAM}
...
\addcontentsline{toc}{section}{[4] \ PIN LAYOUT AND FUNCTIONS}
...
\addcontentsline{toc}{section}{[5] \ REGISTER DESCRIPTION}

\phantomsection
\subsection*{5-1 \, Added Registers}
\addcontentsline{toc}{subsection}{5-1 Added Registers}
...
\addcontentsline{toc}{subsubsection}{5-1-1 \ Horizontal Scroll Function}
...
\ \ \ \ register (R\#2) should be set to“1"\hskip -0.5em.\par
\ \ \ \ The base address of each table will be as follows.\\
\par
\ \ \ \ Pattern name table(PNT) \,\,:\,\,0\,\, to 31(when A15 is set to“0"\hskip -0.5em)\par
\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ 32 to 63(when A15 is set to“1"\hskip -0.5em)\par
...
\addcontentsline{toc}{subsubsection}{5-1-2 \ Wait Function}
...
\addcontentsline{toc}{subsubsection}{5-1-3 \ Command Function}
...
\addcontentsline{toc}{subsubsection}{5-1-4 \ YJK-Type Data Display Function}
