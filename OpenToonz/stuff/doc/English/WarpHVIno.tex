...
\par
"Hori" the red value of the reference image determines the distortion of each pixel.\par
8bits Image\par
...
"Vert" the red value of the reference image determines the distortion of each pixel.\par
Options are the same as "H MaxLen".\\
\\
Alpha Rendering\par
