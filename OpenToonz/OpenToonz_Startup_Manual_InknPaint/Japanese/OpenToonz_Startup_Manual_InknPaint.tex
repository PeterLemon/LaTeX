...
\Huge
\noindent \textbf{目次}\\[-0.75em]
\par
\Large
\noindent \textbf{\uline{\hskip -6em \hskip 6em はじめに\hskip 11.3em}}\\[0.4em]
\footnotesize
\setlength{\tabcolsep}{0em}
\renewcommand{\arraystretch}{1.15}
\begin{tabular}{p{22.2em}l}
\small ■\footnotesize OpenToonz \small での主なファイルフォーマット & \footnotesize p.3\\
\small ■\footnotesize OpenToonz \small のインターフェイス & \footnotesize p.3\\
\small □\footnotesize Room \small について & \footnotesize p.3\\
\small □パネルカスタマイズ & \footnotesize p.3\\
\small □ファイルブラウザのインターフェイス & \footnotesize p.4\\
\end{tabular}\\[1.65em]

\par
\Large
\noindent \textbf{\uline{\hskip -6em \hskip 6em スキャン\hskip 11.5em}}\\[0.2em]
\small □ \footnotesize GTS \small によるスキャン \ \ ※ 「\footnotesize GTS \small 取扱説明書」 を参照してください。\\[1.5em]
\par
\Large
\noindent \textbf{\uline{\hskip -6em \hskip 6em トレース \large (Cleanup)\hskip 9em}}\\[0.4em]
\footnotesize
\setlength{\tabcolsep}{0em}
\renewcommand{\arraystretch}{1.15}
\begin{tabular}{p{22.2em}l}
\small □ \footnotesize tlv \small ファイルの作成 & \footnotesize p.4\\
\multicolumn{2}{l}{\small □\small アンチエイリアスをかけず、 サイズの変更も行わずに \footnotesize tlv \small ファイルを作成する場合 \ \ \ \ \ \footnotesize p.8}\\
\end{tabular}\\[3.6em]

\par
\Large
\noindent \textbf{\uline{\hskip -6em \hskip 6em 仕上げ \ \large (InknPaint)\hskip 8.7em}}\\[0.4em]
\footnotesize
\setlength{\tabcolsep}{0em}
\renewcommand{\arraystretch}{1.15}
\begin{tabular}{p{22.2em}p{8.0em}p{22.2em}l}
\small □ \footnotesize Level \small を読み込む & \footnotesize p.9 & \small □操作の取り消し & \footnotesize p.15\\
\small □ \footnotesize Level \small を保存する & \footnotesize p.9 & \small □連番フレームの表示を送る & \footnotesize p.16\\
\small □新規 \footnotesize Level \small ファイルを作成する & \footnotesize p.9 & \small □フレームの複製・削除 & \footnotesize p.16\\
\small □パレットファイルを保存する & \footnotesize p.9 & \small □画像の表示切り替えに関するメニュー & \footnotesize p.16\\
\small □ \footnotesize Scene \small ファイルを読み込む & \footnotesize p.10 & \small □各種ウィンドウを表示する & \footnotesize p.17\\
\small □ \footnotesize Scene \small ファイルを保存する & \footnotesize p.10 & \small □パレットのスタイルを編集する & \footnotesize p.17\\
\multicolumn{2}{l}{\small □ファイルを閉じる・新規 \footnotesize Scene \small ファイルを作成する \footnotesize \ \ \ \ p.10} & \small □ \footnotesize Studio Palette \small について & \footnotesize p.18\\
\small □ \footnotesize OpenToonz \small を終了する & \footnotesize p.10 & \small □ \footnotesize Studio Palette \small 内でフォルダを作成・削除、 &\\
\small □セルの合成・クミ切り & \footnotesize p.11 & \hskip 1.5em \small 新規パレットを作成する。 & \footnotesize p.18\\
\small □色を絵から抽出する & \footnotesize p.13 & \small □画像を表示する & \footnotesize p.20\\
\small □途切れた線を自動でつなぐ & \footnotesize p.13 & \small □タイムシートの編集を行う & \footnotesize p.21\\
\small □線の修正をする & \footnotesize p.13 & \small □ペイントの際に使用する色見本を表示する & \footnotesize p.21\\
\small □領域を塗りつぶす & \footnotesize p.13 & \small □ファイルをブラウズする & \footnotesize p.22\\
\small □ブラシで描く & \footnotesize p.13 & \small □ \footnotesize tlv \small のフレームを表示する & \footnotesize p.22\\
\small □文字を入力する & \footnotesize p.14 & \small □連番画像を動画でプレビューする & \footnotesize p.23\\
\small □線・塗り領域を消す & \footnotesize p.14 & \multicolumn{2}{l}{\small □環境設定・キーボードショートカットを変更する \footnotesize \ \ \ \ \ \ p.23}\\
\multicolumn{2}{l}{\small □画像で選択した範囲をコピー/貼り付け、 移動する \footnotesize \ \ \ p.14} & \small □各種表示メニュー & \footnotesize p.23\\
\small □ベクター画像を編集する & \footnotesize p.15 & \small □ウィンドウレイアウトを固定する & \footnotesize p.23\\
\small □画像の表示に関わるツール & \footnotesize p.15 & \multicolumn{2}{l}{\small □ \footnotesize tlv \small ファイルをtlv以外のファイル形式に変換する \footnotesize \ \ \ p.24}\\
\end{tabular}\\[1.9em]

\par
\Large
\noindent \textbf{\uline{\hskip -6em \hskip 6em 色指定 \ \large (PltEdit)\hskip 10em}}\\[0.4em]
\footnotesize
\setlength{\tabcolsep}{0em}
\renewcommand{\arraystretch}{1.15}
\begin{tabular}{p{22.2em}l}
\small □色指定を行うためのシートファイルの作成 & \footnotesize p.25\\
\small □必要なフレームのみを表示する & \footnotesize p.25\\
\multicolumn{2}{l}{\small □ダブラシ影などを透けた表示でプレビューする \footnotesize \ \ \ \ \ \ \ \ \ \ p.26}\\
\end{tabular}
...
\\[-1em]
\small
※ tlv は Toonz 上では連番ファイルで表示されますが、 Windows ブラウザ上では1ファイルとして扱われます。\\
...
\noindent OpenToonz のインターフェイスは、 １つの Room (ワークスペース)\\
...
\hskip 4.3em 出力結果の DPI を、 元画像の 90％以下に縮めて処理を行うことが推奨されます。\\
...
\ [Files/New Scene] にし、 再度 [Load Scene] で tnz ファイルを読み込むと、 Xsheet 上の tif 表示 (水色) が tlv 表示 (緑色) に更新されます。\\
\par
...
\noindent 【手順1】\\
\footnotesize
Xsheet に現在作業中の tlv (合成の子。 Match Line を適用したい tlv) の右隣に、 Match Line する tlv (合成の親。 Match Line の tlv) を\\
...
\par
\footnotesize
\noindent \hskip 27.5em ㋐現在作業中の tlv (合成の子。 Match Line を適用したい tlv)\par
\noindent \hskip 27.5em ㋑Match Line する tlv (合成の親。 Match Line の tlv)\\[-5em]
...
\scriptsize{・オリジナル \ \ \ 下・アンチエイリアスはそのまま}\\[-0.3em]
\scriptsize{・Match Lines 上・アンチエイリアスはオリジナ}\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Style Picker Tool…tlv からクリックした部分の色の抽出・スタイル番号などの情報を知るための機能です。\par
\footnotesize
...
\normalsize
\noindent\hskip 1.3em RGB Picker Tool…tlv や tif など、 Viewer に表示されている色 (RGB 値 ) を抽出する機能です。\par
\footnotesize
...
\normalsize
\noindent\hskip 1.3em Tape Tool…途切れている線画に対して、 自動的に線をつなげる機能です。\par
\footnotesize
...
\normalsize
\noindent\hskip 1.3em Finger Tool…線画に対して使用します。 線画の上をなぞると、 三方を囲まれた穴を埋めることができる\\
機能です。\par
\footnotesize
...
\normalsize
\noindent\hskip 1.3em Fill Tool…面の領域と線画に対してペイントできる機能です。\par
\footnotesize
...
\normalsize
\noindent\hskip 1.3em Brush Tool…ブラシサイズで Line が自由に描ける機能です。\par
\footnotesize
...
\normalsize
\noindent\hskip 1.3em Paint Brush Tool…ブラシサイズで、 面の領域と線画に対してペイントできる機能です。\par
\footnotesize
\noindent ツールの○の範囲内のみペイントが実行されます。\\
...
\normalsize
\noindent\hskip 1.3em Geometric Tool…直線や多角形などが描ける機能です。\par
\footnotesize
...
\normalsize
\noindent\hskip 1.3em Type Tool…tlv に文字が描ける機能です。\par
\footnotesize
...
\normalsize
\noindent\hskip 1.3em Eraser Tool…面の領域や線画に対して消去を行う機能です。\par
\footnotesize
...
\normalsize
\noindent\hskip 1.3em Edit Tool…カメラの選択、 移動、 比率の変更などの編集を行う機能です。\par
\footnotesize
...
\normalsize
\noindent\hskip 1.3em Selection Tool…Viewer ウィンドウ上で、 画像の特定範囲を選択する機能です。\par
\footnotesize
...
\normalsize
\noindent\hskip 1.3em Control Point Editor Tool…コントロールポイントを編集して、 ベクターの形を変更する機能です。\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Pinch Tool…ベクターのどこかをクリック＆ドラッグすることで、 ベクターの形を変更する機能です。\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Pump Tool…ベクター線の太さを変更する機能です。 変更したい範囲をクリック＆ドラッグして使用しま\\
す。\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Magnet Tool…複数のベクターを変更する機能です。 変更したい範囲をクリック＆ドラッグして使用しま\\
す。\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Bender Tool…ベクター線を曲げる機能です。\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Iron Tool…ベクター線のしわを修正する機能です。 修正したいベクター線上でカーソルを動かして使用\\
します。\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Cutter Tool…ベクター線をクリックした箇所で切る機能です。\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Skeleton Tool…キャラクターモデルを定義し、 切り絵アニメーションとして動かす機能です。\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Hook Tool…ステージスキマティックにおいて、 ものを動かしたり、 2 つのものをつなぐ際の基準点を定\\
義する機能です。\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Tracker Tool…一連の画像において、 特定の部分を追跡する機能です。\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Plastic Tool…キャラクター、 もしくはその一部を変形して動かすためのメッシュを作成する機能です。\\
\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Zoom Tool…画像を拡大・縮小する機能です。\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Rotate Tool…Viewer の画像表示を作業用に回転します。\\[-0.3em]
...
\normalsize
\noindent\hskip 1.3em Hand Tool…Viewer 上を移動する機能です。 クリック＆ドラッグして使用します。\\[-0.3em]
...
\noindent \hskip 31.25em ⑤ [Full Matte]: 選択したスタイルの Matte の値を全て 255 に\par
\noindent \hskip 31.25em します。\par
\noindent \hskip 31.25em ⑥ [Zero Matte]: 選択したスタイルの Matte の値を全て 0 にし\par
\noindent \hskip 31.25em ます。\par
\noindent \hskip 31.25em ⑦ [Fade To Color]: Color で RGBM 値を設定し Fade To ボタン\par
...
\noindent \hskip 17em Toonz Palettes…\small\$TOONZSTUDIOPALETTES \normalsize で指定されたフォルダ (通常は\par
...
\par
\noindent \hskip 21.25em 【右クリックメニュー】\par
...
\footnotesize
\noindent [Camera Box]: Output Settings で設定したカメラサイズを、 Viewer 上に赤色の破線で表示します。 *InknPaint Room で tlv を選択して\\
いるときには表示されません。\\
...
\noindent \hskip 30.25em [Action]: 一方は keep を選択し、 もう一方のセルは Delete を選択\par
